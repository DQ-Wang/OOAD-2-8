...
{
   default String createWayBill(AfterSale afterSale, ExpressClient expressClient)
   {
       ...
       ResponseEntity<String> expressId = expressClient.createExpress(afterSale.getShopId(),createExpressDto);
